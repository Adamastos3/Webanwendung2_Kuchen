...
class BestellungDao {
  ...
  loadById(id) {
    ...
    for (i = 0; i < result.bestellpositionen.length; i++) {
      ...
      result.total.mehrwertsteuer +=
        result.bestellpositionen[i].mehrwertsteuersumme;
    }
  ...
  loadAll() {
    ...
    for (var i = 0; i < result.length; i++) {
      ...
      result[i].total.mehrwertsteuer = helper.round(
        result[i].total.mehrwertsteuer
      );
    }
