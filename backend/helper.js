...
module.exports.jsonMsg = function (
  message = "OK",
  payload = null,
  error = false
) {
...
module.exports.arrayObjectKeysToLower = function (arr) {
  for (i = 0; i < arr.length; i++) arr[i] = this.objectKeysToLower(arr[i]);
  return arr;
};
...
// returns current date time + 2 days
module.exports.getNowPlusTwo = function () {
